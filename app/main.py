...
PRESETS = {
    ...
    "dramatic": {
        "label": "Dramatic",
        "base_radius_multiplier": 1.1,
        "core_height_multiplier": 1.15,
        "branch_density_multiplier": 1.25,
        "branch_thickness_multiplier": 1.0,
    },
}
...
def render_scad(template: str, model_data: dict[str, Any], title: str, region_filter: str = "") -> str:
    branch_blocks = []
